<template>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu notifications">
            <li><a v-for="unread in unreadNotifications" href="/inbox" class="notification-item"><span class="dot bg-success" > {{unread.data.submission.form_id}} submited by {{unread.data.submission.user_id}} </span></a></li>
