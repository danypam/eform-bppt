...
<p class="h3"> There is one task to do. Please click the link <a href="{{ $detail['url'] }}">http://taskbyid</a> to take the task</p>
<p class="h3"> Here is the data that need to do</p>
<div class="main">
