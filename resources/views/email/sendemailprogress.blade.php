                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%">
                                                                    <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:20px">Permohonan Anda sedang diproses PIC</h1>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                    <img src="https://66.media.tumblr.com/73ae564b3646cb9e24c99e65d1a0f03e/70bdf9d7e190cc98-67/s1280x1920/0e933bfb46a2fa6a0ff81f1c29cf7ee7cc9c68ea.png" width="100%"><br><br>
                                                                    ...
                                                                    <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">Mohon tunggu. Permohonan Anda sedang diproses oleh {{Auth::user()->name}}. Tekan tombol di bawah ini apabila ingin melihat detail proses permohonan Anda</p>
